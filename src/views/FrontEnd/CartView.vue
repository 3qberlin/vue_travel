<template>
  <TravelConditions v-if="this.carts.length >= 1" />
  <div class="container">
    <div class="mt-3">
      ...
      <div class="row">
        ...
        <div class="col-md-4" v-if="this.carts.length >= 1">
          <div class="border p-4 mb-4">
            ...
            <table class="table text-muted border-bottom">
              <tbody>
                <tr>
                  <th
                    scope="row"
                    class="border-0 px-0 pt-4 font-weight-normal d-flex flex-grow-1"
                  >
                    旅遊期間
                  </th>
                  <td
                  ...
                  <td
                    v-else
                    class="text-end border-0 px-0 pt-3 d-flex flex-wrap w-100"
                  >
                    <div class="w-100">
                      {{ startTime }}
                    </div>
                ...
                <tr>
                  ...
                  <td class="text-end border-0 px-0 pt-3" v-else>
                    {{ selectedPeople }}
                  </td>
                </tr>
                <tr>
                  ...
                  <td class="text-end border-0 px-0">NT${{ this.total }}</td>
                </tr>
                <tr>
                  <th
                    scope="row"
            ...
            >
              <button class="btn btn-dark w-100 mt-4">送出訂單</button>
            </RouterLink>
          </div>
        </div>
      </div>
    </div>
    <p class="fs-5 text-center my-13" v-if="this.carts.length <= 0">
