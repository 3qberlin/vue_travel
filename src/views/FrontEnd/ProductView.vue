<template>
  ...
  <div class="container">
        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-white px-0 mb-0 py-3">
            <li class="breadcrumb-item">
              <RouterLink to="/home" class="text-secondary">首頁</RouterLink>
            </li>
            <li class="breadcrumb-item">
            ...
            <li class="breadcrumb-item active" aria-current="page">單一產品說明</li>
          </ol>
        </nav>
    ...
    <h5 class="fw-bold mt-5 px-md-11 lh-base mt-7"
        ...
        <div class="swiper-slide">
          <div class="card border-0 mb-4 position-relative position-relative">
            <img
              ...
              class="card-img-top rounded-0 px-md-11"
              alt="images"
            />
            ...
            <div class="card-body p-0">
              ...
              <p class="card-text mb-0 fs-5 mt-5 px-md-11 lh-base">
